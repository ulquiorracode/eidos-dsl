...
/// </summary>
public abstract class RegistryBase(ImmutableDictionary<string, ImmutableArray<string>> map) : EidosBase, IRegistry
{
    protected readonly ImmutableDictionary<string, ImmutableArray<string>> _map = map ?? [];
